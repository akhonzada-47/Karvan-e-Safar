...
public class Destination implements Serializable {
    ...
    public Destination(String trip_From, String trip_To){
        if(  (trip_From.equalsIgnoreCase("Islamabad") ||trip_From.equalsIgnoreCase("Lahore") ||trip_From.equalsIgnoreCase("Karachi")  ) &&
                ( trip_To.equalsIgnoreCase("Skardu") || trip_To.equalsIgnoreCase("Hunza")
                        || trip_To.equalsIgnoreCase("Gilgit"))) {
